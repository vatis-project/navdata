...
### Data Format
The `airports.yaml` file contains data for airports. An airport is composed of five properties: `ID`, `Name`, `Lat` (Latitude), `Lon` (Longitude) and `Elev` (Elevation in Meters)
